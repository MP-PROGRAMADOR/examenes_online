                        ...
                        <form action="../php/guardar_estudante.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="escuela_id" class="form-select" required>
                                            ...
                                            try {
                                                $sql = "SELECT id, nombre FROM escuelas_conduccion ORDER BY nombre ASC"; // Select specific columns and order
                                                ...
                                                $stmt = null; // Release statement resource
                                                $pdo->closeConexion();
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="codigo_registro_examen" class="form-label">Código de Registro para
                                            el Examen:</label>
